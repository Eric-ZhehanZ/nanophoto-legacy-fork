...
const getMissingAiTextFields = ({
  ...
  caption, captionZh,
  tags,
  semanticDescription, semanticDescriptionZh,
}: PhotoDb | Photo): AiAutoGeneratedField[] =>
  AI_CONTENT_GENERATION_ENABLED
    ? AI_TEXT_AUTO_GENERATED_FIELDS.reduce((fields, field) => {
      switch (field) {
        case 'title':
          return (!title || !titleZh) ? [...fields, 'title'] : fields;
        case 'caption':
          return (!caption || !captionZh) ? [...fields, 'caption'] : fields;
        case 'tags':
          return (tags ?? []).length === 0 ? [...fields, 'tags'] : fields;
        case 'semantic':
          return (!semanticDescription || !semanticDescriptionZh) ? [...fields, 'semantic'] : fields;
      }
